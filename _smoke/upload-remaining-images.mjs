// Upload hero images for Madre Patria and San Miguel Mule.
// Run: node --env-file=.env.local _smoke/upload-remaining-images.mjs
...
const MAPPING = [
  { slug: 'madre-patria', file: `${CACHE}/30.png` },
  { slug: 'san-miguel-mule', file: `${CACHE}/31.png` },
]
